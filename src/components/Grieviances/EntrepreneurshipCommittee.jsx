...
import { entrepreneurshipCommitteeHero } from '../common/data/heroData';

const members = [
  
];

const EntrepreneurshipCommittee = () => {
  ...
  return (
    <div>
      {/* Hero */}
      <HeroSection {...entrepreneurshipCommitteeHero} />
...
export default EntrepreneurshipCommittee;
