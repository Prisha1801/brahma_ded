...
import { antiHarassmentCommitteeHero } from '../common/data/heroData';

const members = [
  
];

const AntiHarassmentCommittee = () => {
  ...
  return (
    <div>
      {/* Hero */}
      <HeroSection {...antiHarassmentCommitteeHero} />
...
export default AntiHarassmentCommittee;
