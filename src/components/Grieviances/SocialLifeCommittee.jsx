...
import { socialLifeCommitteeHero } from '../common/data/heroData';

const members = [
  
];

const SocialLifeCommittee = () => {
  ...
  return (
    <div>
      {/* Hero */}
      <HeroSection {...socialLifeCommitteeHero} />
...
export default SocialLifeCommittee;
